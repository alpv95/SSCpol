...
helical_set = [[np.sin(theta_obs)-np.cos(theta_obs)*np.sin(i*np.pi/30),np.cos(i*np.pi/30),np.sin(theta_obs)*np.sin(i*np.pi/30)+np.cos(theta_obs)] for i in range(60)]
